#ifndef OCTOMAP_SERVER_OBJECT_PROBABILITY_H
#define OCTOMAP_SERVER_OBJECT_PROBABILITY_H
...
class OctomapServerObjectProbability {
...
public:
  ...
  OctomapServerObjectProbability(ros::NodeHandle private_nh_ = ros::NodeHandle("~"));
  virtual ~OctomapServerObjectProbability();
...
protected:
  ...
  */
  ...
  message_filters::Subscriber<sensor_msgs::Image>* m_objProbaImageSub;
  ...
  message_filters::Synchronizer<ApproximateSyncPolicy>* m_sync;
