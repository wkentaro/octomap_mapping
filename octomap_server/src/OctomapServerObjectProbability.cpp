  ...
  m_initConfig(true)
{
  ...
  m_octomapFullService = m_nh.advertiseService("octomap_full", &OctomapServerObjectProbability::octomapFullSrv, this);
  m_clearBBXService = private_nh.advertiseService("clear_bbx", &OctomapServerObjectProbability::clearBBXSrv, this);
  m_resetService = private_nh.advertiseService("reset", &OctomapServerObjectProbability::resetSrv, this);
...
bool OctomapServerObjectProbability::openFile(const std::string& filename){
...
bool OctomapServerObjectProbability::octomapFullSrv(OctomapSrv::Request  &req,
                                    OctomapSrv::Response &res)
{
...
void OctomapServerObjectProbability::adjustMapData(nav_msgs::OccupancyGrid& map, const nav_msgs::MapMetaData& oldMapInfo) const{
...
std_msgs::ColorRGBA OctomapServerObjectProbability::heightMapColor(double h) {
